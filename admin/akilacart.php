...
<div class="row">
    <div class="col-md-3">
        <div id="container">
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-12 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">Administrator Control Panel</span>
        </a>
    </div>
...
<div id="page">
    <div id="container">
        ...
        <hr>
        <form name="GroceriestatusForm" id="GroceriestatusForm" method="post" action="index.php"
