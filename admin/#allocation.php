    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Allocations</li>
          </ol>
          <h5 class="font-weight-bolder mb-0">Allocations</h5>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
                    ...
                    <div class="col-lg-4 mb-lg-0 mb-4">
                        ...
                        <div class="card" style="height: 70vh;">
                            ...
                            <div class="row">
                                ...
                                <div class="d-flex flex-column h-100">
                                    <p class="mb-1 pt-2 text-bold"></p>
                                    <h5 class="font-weight-bolder">COUNTER RESERVATIONS </h5>
                                    <!-- Content here -->
                                            ...
                                            <tr>
                                                ...
                                                <td><select class="form-select" aria-label="Default select example" name="reservationid" id="reservationid">
                                                        <option value="select">- SELECT RESERVATION -
                                                            <?php
                                                            //loop through reservations_details counter rows
