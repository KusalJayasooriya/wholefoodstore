      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="./reservations.php">
            ...
            <span class="nav-link-text ms-1">Counter Reservation List</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">GROCERIES - CATEGORIES</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
          ...
          <div class="card">
            <div class="card-body p-3">
              ...
              <div class="input-group mb-3">
                <input type="text" name="name" class="form-control" id="validationTooltip01" placeholder="ADD A NEW CATEGORY TO GROCERIES" aria-label="ADD A NEW CATEGORY" aria-describedby="button-addon2" required>
