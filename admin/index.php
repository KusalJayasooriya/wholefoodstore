          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Reserved Counters</p>
                    <h5 class="font-weight-bolder mb-0">
                      <?php
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    ...
                    <p class="mb-5">Allocate Orders and Counter Reservations</p>
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('./assets/img/add-foods.jpg');">
              ...
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">Add Items</h5>
                <p class="text-white">New Grocery Categories or New Grocery Items </p>
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                  <div class="card card-blog card-plain">
                    ...
                    <div class="card-body px-1 pb-0">
                      ...
                      <p class="mb-4 text-sm">
                      Find out available Counter Counter Reservation Lists..
                      </p>
                      <div class="d-flex align-items-center justify-content-between">
                      <a href="./reservations.php">
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                  <div class="card card-blog card-plain">
                    ...
                    <div class="card-body px-1 pb-0">
                      ...
                      <p class="mb-4 text-sm">
                        View Registered customers details and manage customers from the website.
                      </p>
                      <div class="d-flex align-items-center justify-content-between">
                      <a href="./accounts.php">
