...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#">
        ...
        <span class="ms-1 font-weight-bold">WFS</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto max-height-vh-100 h-100" id="sidenav-collapse-main" style="overflow: initial;">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Available Lists</h6>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#">
            ...
            <span class="nav-link-text ms-1">Counter Counter Reservation List</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h5 class="font-weight-bolder mb-0">Counter Reservations</h5>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
          ...
          <div class="row mt-4">
              ...
              <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                      <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Counter Reservations Placed</button>
                      <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Confirmed Counter Reservations</button>
                      <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Cancelled Counter Reservations</button>
                  </div>
              </nav>
              <div class="tab-content" id="nav-tabContent">
                  ...
                  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      ...
                      <div class="table-responsive">
                          ...
                          <tr>
                              ...
                              <th class="text-uppercase text-secondary text-s font-weight-bolder opacity-7">Counter Number</th>
                          ...
                          while ($row=mysqli_fetch_array($tables)){
                              ...
                              echo "<td>";
                                ...
                                if ($row['Reserve_Time'] == '08:00:00'){
                                    echo '<span class="badge bg-gradient-faded-dark">' . 'Morning' . '</span>';
                                }elseif ($row['Reserve_Time'] == '12:00:00'){
                                    echo '<span class="badge bg-gradient-faded-dark">' . ' Afternoon ' . '</span>';
                                }else{
                                    echo '<span class="badge bg-gradient-faded-dark">' . 'Evening' . '</span>';
                                }
                              ?>
                              </td>
                             ...
                             <td>
                                  <?php
                                      ...
                                      <ul class="list-inline m-0">
                                          ...
                                          <li class="list-inline-item" data-toggle="tooltip" title="RESERVATION CONFIRMATION">
                                                  ...
                                                  <div class="modal-dialog">
                                                      <div class="modal-content">
                                                          ...
                                                          <div class="modal-footer">
                                                              ...
                                                              <?php echo '<a class="btn btn-info deliver_order_button" href="delete-reservation.php?delivery='."ok".'&id='.$row['ReservationID'].'">CONFIRM</a>'; ?>
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
                                              ...
                                              <li class="list-inline-item" data-toggle="tooltip" title="RESERVATION CANCELLATION">
                      ...
                      <div class="table-responsive">
                          <table class="table table-hover align-items-center mb-0">
                              ...
                              <tr>
                                <th class="text-uppercase text-secondary text-s font-weight-bolder opacity-7">Reservation ID</th>
                                <th class="text-uppercase text-secondary text-s font-weight-bolder opacity-7">Customer's ID</th>
                                <th class="text-uppercase text-secondary text-s font-weight-bolder opacity-7">Table Number</th>
                                <th class="text-uppercase text-secondary text-s font-weight-bolder opacity-7">Reserved Date</th>
                                <th class="text-uppercase text-secondary text-s font-weight-bolder opacity-7">Reserved Time</th>
                  ...
                  <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                      ...
                      <?php
                      //selecting all records from the reservations_details table based on table ids. Return an error if there are no records in the table
                      $tables3=mysqli_query($conn,"SELECT customers.member_id, customers.firstname, customers.email, customers.lastname, reservations_details.ReservationID,reservations_details.table_id, reservations_details.Reserve_Date, reservations_details.Reserve_Time, reservations_details.reason, billing_details.Mobile_No, billing_details.Landline_No  FROM (( reservations_details INNER JOIN customers ON reservations_details.member_id=customers.member_id)INNER JOIN billing_details ON reservations_details.member_id=billing_details.member_id) WHERE reservations_details.flag = 2")
                      or die("There are no records to display ... \n" . mysqli_error());
                      echo(mysqli_error($conn));
                      ?>
                      <div class="table-responsive">
                          ...
                          while ($row=mysqli_fetch_array($tables3)) {
                              ...
                              <td>
                                  <!-- Button trigger modal -->
                                  <button type="button" class="btn bg-gradient-info" data-bs-toggle="modal" data-bs-target="#exampleModal6">
                                      <?php echo $row['member_id']; ?>
                                  </button>
