...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Groceries</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Grocery Management</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
    <div class="container-fluid">
        <div class="row mt-4">
        <h3 class="font-weight-bolder ">GROCERIES</h3>
              ...
              <div class="row">
                <div>
                  <div class="d-flex flex-column h-100">
                    ...
                    <h5 class="font-weight-bolder">Add Grocery ITEMS</h5>
                    <p class="mb-5">Add groceries or view available groceries</p>
                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="./foods.php">
                    <button type="button" class="btn btn-secondary btn-lg">Add grocery items</button>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="card-body p-3">
              <div class="row">
                <div>
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold"></p>
                    <h5 class="font-weight-bolder">Add Grocery CATEGORIES</h5>
                    <p class="mb-5">Add categories or view available categories</p>
                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="./categories.php">
                    <button type="button" class="btn btn-secondary btn-lg">Add grocery category</button>
                    </a>
                  </div>
                </div>
              </div>
      ...
      <div class="row mt-4">
       <h3 class="font-weight-bolder ">STATIONARIES</h3>
        <div class="col-lg-6 mb-lg-0 mb-4">
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div>
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold"></p>
                    <h5 class="font-weight-bolder">Add Stationary ITEMS</h5>
                    <p class="mb-5">Add stationaries or view available stationaries</p>
                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="./foods-lounge.php">
                    <button type="button" class="btn btn-primary btn-lg">Add stationary items</button>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="card-body p-3">
              <div class="row">
                <div>
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold"></p>
                    <h5 class="font-weight-bolder">Add Stationary CATEGORIES</h5>
                    <p class="mb-5">Add categories or view available categories</p>
                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="./categories-lounge.php">
                    <button type="button" class="btn btn-primary btn-lg">Add stationary Category</button>
                    </a>
                  </div>
                </div>
              </div>
